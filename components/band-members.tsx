      ...
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Four musicians who have shaped the sound of Nepali rock for three
            decades
          </p>
        </motion.div>
            ...
            <motion.div
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    "inset 0 1px 1px rgba(255,255,255,0.05), 0 4px 12px rgba(0,0,0,0.3)",
                }}>
                <Image
                  src={member.image}
                  alt={member.name}
                  width={400}
                  height={400}
                  className="object-cover w-full h-58 object-top"
                />
                {/* Top accent bar */}
                ...
                <div className="p-5">
                  ...
                  <div className="relative w-14 h-14 mb-4">
                    <div
                      ...
                      style={{
                        ...
                        boxShadow:
                          "inset 0 2px 6px rgba(0,0,0,0.4), 0 2px 4px rgba(0,0,0,0.3)",
                      }}
                    />
                  ...
                  {/* Info */}
                  <h3 className="text-lg font-serif mb-1 text-foreground">
                    {member.name}
                  </h3>
          ...
          <div
            ...
            <div className="relative aspect-[4/3] lg:aspect-auto">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(180deg, rgba(217,119,6,0.9) 0%, rgba(180,83,9,0.9) 100%)",
                  boxShadow: "0 2px 8px rgba(217,119,6,0.4)",
                }}>
                <span className="text-xs uppercase tracking-wider text-primary-foreground font-medium">
                  30 Years of Rock
                </span>
              </div>
            </div>
            ...
            <div className="p-8 lg:p-10 flex flex-col justify-center">
              <h3 className="text-2xl md:text-3xl font-serif mb-6 text-foreground">
                The Legend & Legacy
              </h3>
              ...
              <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
                ...
                <p>
                  ...
                  speaking to universal themes of freedom, revival, and the
                  human spirit.
                </p>
              </div>
              ...
              <div className="flex gap-8 mt-8 pt-6 border-t border-zinc-800">
                {[
                  ...
                  <div key={i} className="text-center">
                    <p className="text-2xl font-mono text-primary amber-glow">
                      {stat.value}
                    </p>
                    <p className="text-[9px] uppercase tracking-[0.15em] text-zinc-500 mt-1">
                      {stat.label}
                    </p>
                  </div>
                ))}
