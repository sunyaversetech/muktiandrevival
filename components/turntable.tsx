...
export function Turntable() {
  ...
  // 1. Create a ref to persist the HTMLAudioElement instance
  const audioRef = useRef<HTMLAudioElement | null>(null);

  // 2. Instantiate the audio object inside useEffect safely on the client side
  useEffect(() => {
    audioRef.current = new Audio("/audio/tour-preview.mp3");

    // Optional: Loop the track if it reaches the end while platter is spinning
  ...
  // 3. Play or pause the audio depending on the isPlaying state change
  useEffect(() => {
    ...
    if (isPlaying) {
      audioRef.current.play().catch((error) => {
        ...
        // Fallback in case browser blocks autoplay restrictions
        setIsPlaying(false);
      });
    } else {
      audioRef.current.pause();
  ...
  return (
    <div className="relative w-full max-w-[650px] mx-auto px-2 sm:px-0">
      ...
      <div className="relative">
        {/* Wood Cabinet Base */}
        <div
          className="absolute inset-0 wood-cabinet rounded-lg"
          style={{
            boxShadow:
              "0 20px 60px rgba(0,0,0,0.6), 0 8px 20px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.05)",
          }}
        />

        {/* Brushed Metal Top Plate */}
        <div
          className="relative brushed-steel rounded-md m-1.5 sm:m-2 p-4 sm:p-6 md:p-8"
          style={{
            boxShadow:
          ...
          {[
            ["top-2 left-2 sm:top-3 sm:left-3", "-45deg"],
            ["top-2 right-2 sm:top-3 sm:right-3", "45deg"],
            ["bottom-2 left-2 sm:bottom-3 sm:left-3", "-135deg"],
            ["bottom-2 right-2 sm:bottom-3 sm:right-3", "135deg"],
          ].map(([pos, rotation], i) => (
            <div
              key={i}
              className={`absolute ${pos} w-2 h-2 sm:w-3 sm:h-3 rounded-full hidden xs:block`}
              style={{
                background:
                  "linear-gradient(145deg, #666 0%, #444 50%, #555 100%)",
                boxShadow:
              ...
              <div
                ...
                <div
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1.5 sm:w-2 h-0.5 bg-zinc-600 rounded-full"
                  style={{
          ...
          <div className="relative aspect-square max-w-[280px] sm:max-w-[320px] md:max-w-[380px] mx-auto mb-4 sm:mb-6">
            ...
            <div
              ...
              style={{
                ...
                boxShadow:
                  "inset 0 4px 15px rgba(0,0,0,0.8), 0 2px 8px rgba(0,0,0,0.5)",
              }}
            />
            ...
            <div
              ...
              {/* Strobe dots ring */}
              <div
                className={`absolute inset-0 ${isPlaying ? "animate-spin-vinyl" : ""}`}
                style={{
            ...
            <motion.div
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(130deg, rgba(255,255,255,0.12) 0%, transparent 40%, rgba(0,0,0,0.15) 100%)",
                }}
              />

              {/* Center Label */}
              <div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[32%] aspect-square rounded-full overflow-hidden"
                style={{
                  boxShadow:
                ...
                {/* Center Spindle Hole */}
                <div
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 sm:w-4 sm:h-4 rounded-full bg-gradient-to-b from-zinc-700 to-zinc-900 border-2 border-zinc-600"
                  style={{
            ...
            {/* Center Spindle */}
            <div
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 rounded-full z-10"
              style={{
                background:
                  "linear-gradient(180deg, #888 0%, #555 50%, #666 100%)",
                boxShadow:
            ...
            <div className="relative w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20">
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    "inset 0 2px 4px rgba(0,0,0,0.4), 0 4px 12px rgba(0,0,0,0.5)",
                }}
              />
              <div
              ...
              <motion.div
                ...
                <div
                  ...
                  {/* Counter Weight */}
                  <div
                    className="absolute -top-1 -right-1 w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 rounded-full"
                    style={{
                      background:
                        "linear-gradient(180deg, #555 0%, #333 50%, #444 100%)",
                      boxShadow:
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(180deg, #777 0%, #555 30%, #666 70%, #555 100%)",
              ...
              <div
                className="absolute -bottom-3 sm:-bottom-4 -left-3 sm:-left-4 w-6 h-4 sm:w-8 sm:h-6 rounded-sm hidden sm:block"
                style={{
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-4 sm:gap-6">
              ...
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                />
                <span className="text-[8px] sm:text-[9px] uppercase tracking-[0.15em] text-zinc-500">
                  Power
                </span>
              </div>
            ...
            {/* Right - Volume Knob */}
            <div className="flex items-center gap-1.5 sm:gap-2">
              {/* ... Volume knob code remains unchanged ... */}
              <span className="text-[8px] sm:text-[9px] uppercase tracking-[0.15em] text-zinc-500">
                Vol
              </span>
          ...
          <div className="absolute bottom-2 sm:bottom-3 left-1/2 -translate-x-1/2 text-center">
            <p className="text-[7px] sm:text-[8px] tracking-[0.3em] sm:tracking-[0.4em] uppercase text-zinc-600 embossed-text">
              Mukti & Revival
            </p>
            <p className="text-[5px] sm:text-[6px] tracking-[0.15em] sm:tracking-[0.2em] uppercase text-zinc-700 hidden sm:block">
...
function VUMeter({
  ...
  return (
    <div
      className="w-20 h-14 sm:w-24 sm:h-16 md:w-28 md:h-20 rounded-sm overflow-hidden"
      style={{
              ...
              return (
                <g key={i}>
                  <line
                    ...
                    x2={x2}
                    y2={y2}
                    stroke={mark.angle > 5 ? "#c00" : "#333"}
                    strokeWidth="1"
                  />
                  <text
                    x={tx}
                    y={ty}
                    fill={mark.angle > 5 ? "#c00" : "#333"}
                    fontSize="6"
                    textAnchor="middle"
